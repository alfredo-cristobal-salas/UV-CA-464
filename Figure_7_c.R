...
#
#################################################
g_con_escala <- as.vector(t(datos[22:28,1]))
T_con_escala <- as.vector(t(datos[22:28,2]))
L_con_escala <- as.vector(t(datos[22:28,3]))
m_real_con_escala <- 1 - as.vector(t(datos[22:28,4]))
