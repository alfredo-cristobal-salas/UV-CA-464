...
#
#################################################
g_con_escala <- as.vector(t(datos[106:112,1]))
T_con_escala <- as.vector(t(datos[106:112,2]))
L_con_escala <- as.vector(t(datos[106:112,3]))
m_real_con_escala <- 1 - as.vector(t(datos[106:112,4]))
...
grafica_curvas <- cbind(t=tiempo_de_captura, real=5*(m_real_sin_escala/100), generada=5*(m_generada_sin_escala/100))
