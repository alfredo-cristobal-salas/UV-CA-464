...
#
#################################################
g_con_escala <- as.vector(t(datos[43:49,1]))
T_con_escala <- as.vector(t(datos[43:49,2]))
L_con_escala <- as.vector(t(datos[43:49,3]))
m_real_con_escala <- 1 - as.vector(t(datos[43:49,4]))
