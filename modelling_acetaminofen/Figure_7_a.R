...
#
#################################################
g_con_escala <- as.vector(t(datos[1:7,1]))
T_con_escala <- as.vector(t(datos[1:7,2]))
L_con_escala <- as.vector(t(datos[1:7,3]))
m_real_con_escala <- 1 - as.vector(t(datos[1:7,4]))
