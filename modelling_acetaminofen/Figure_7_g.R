...
#
#################################################
g_con_escala <- as.vector(t(datos[64:70,1]))
T_con_escala <- as.vector(t(datos[64:70,2]))
L_con_escala <- as.vector(t(datos[64:70,3]))
m_real_con_escala <- 1 - as.vector(t(datos[64:70,4]))
