...
#
#################################################
g_con_escala <- as.vector(t(datos[148:154,1]))
T_con_escala <- as.vector(t(datos[148:154,2]))
L_con_escala <- as.vector(t(datos[148:154,3]))
m_real_con_escala <- 1 - as.vector(t(datos[148:154,4]))
...
grafica_curvas <- cbind(t=tiempo_de_captura, real=10*(m_real_sin_escala/100), generada=10*(m_generada_sin_escala/100))
